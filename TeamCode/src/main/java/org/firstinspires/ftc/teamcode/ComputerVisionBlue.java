...
//
//public class ComputerVisionBlue {
//
//    private OpenCvCamera cam;
//    private final int rows = 3;
//    private final int columns = 3;
//    private final int fractions = 0;
//
//    private final double[][] cameraMatrix = new double[rows][columns];
//    private double[] leftVision = new double[columns];
//    private double[] centerVision = new double[columns];
//    private double[] rightVision = new double[columns];
//
//    private final double[][] botRight = new double[fractions][2];
//    private int[][] avgRGB = new int[rows][columns];
//    private int[] RED;
//    private int[] GREEN;
//    private int[] BLUE;
//    private int x;
...
//
//    public ComputerVisionBlue(int camId) {
//
//        for(int i = 0; i<3; i++){
//            leftVision[i] = cameraMatrix[i][0];
//            centerVision[i] = cameraMatrix[i][1];
//            rightVision[i] = cameraMatrix[i][2];
//        }
...
////        }
//        cam = OpenCvCameraFactory.getInstance().createInternalCamera(OpenCvInternalCamera.CameraDirection.BACK, camId);
//        cam.setPipeline(new ComputerVisionBlue.Pipeline());
...
//                        input,
//                        new Point(
//                                input.cols() * leftVision[longestSeq[0]][0],
//                                input.rows() * leftVision[longestSeq[1]][1]),
//                        new Point(
